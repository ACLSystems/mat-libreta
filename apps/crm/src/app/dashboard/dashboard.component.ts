...
import { TableData } from '@crmmd/md-table/md-table.component';
import { LegendItem, ChartType } from '@crmmd/md-chart/md-chart.component';
...
export class DashboardComponent implements OnInit {
	...
	ngOnInit() {
		this.tableData = {
				...
				dataRows: [
						['US', 'Estados Unidos', '2.920	', '53.23%'],
						['DE', 'Alemania', '1.300', '20.43%'],
						['AU', 'Australia', '760', '10.35%'],
						['GB', 'Reino Unido', '690', '7.87%'],
						['RO', 'Rumania', '600', '5.94%'],
						['BR', 'Brasil', '550', '4.34%'],
						['AR', 'Argentina', '500', '4.14%'],
						['MX', 'México', '400', '3.78%']
				]
		 };
